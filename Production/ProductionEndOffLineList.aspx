<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="ProductionEndOffLineList.aspx.cs" Inherits="DotMercy.custom.Production.ProductionEndOffLineList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <dx:ASPxGridView ID="gridCondition" ClientInstanceName="gridPosition" runat="server" AutoGenerateColumns="False" KeyFieldName="ItemId" Width="100%">
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="ItemId" ReadOnly="True" Visible="False" VisibleIndex="0"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="ModelName" VisibleIndex="3"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="VariantName" VisibleIndex="2"></dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn FieldName="VINNumber" VisibleIndex="0">
           
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn FieldName="LineId" VisibleIndex="5" GroupIndex="0" SortIndex="0" SortOrder="Ascending"></dx:GridViewDataTextColumn>
