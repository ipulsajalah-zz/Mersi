...
{
    public partial class OfflineRectification : Ebiz.Scaffolding.WebForm.UI.CustomPage
    {
        ...
        {
            if (_condition == "isVoca" || _condition == "isPA")
            {
                ...
                //      "window.open('../Production/ProductionVoca.aspx?Type=" + 0 + "&Hist=" + HisId + "&Stat=" + StationId + "&Condition=" + _condition + "','_newtab');",
                //      true);
                Response.Redirect("../Production/ProductionVoca.aspx?Type=" + 0 + "&Hist=" + HisId + "&Stat=" + StationId + "&Condition=" + _condition + "");
            }
            else if (_condition == "isRecti")
            {
                ASPxButton btn = sender as ASPxButton;
                ...
                var HisId = gridCondition.GetRowValues(index, "ItemId");
                //Page.ClientScript.RegisterStartupScript(this.GetType(), "OpenWindow",
                //      "window.open('../Production/ProductionRectification.aspx?Type=" + 0 + "&Hist=" + HisId + "&Stat=" + StationId + "','_newtab');",
                //      true);
                Response.Redirect("../Production/ProductionRectification.aspx?Type=" + 0 + "&Hist=" + HisId + "&Stat=" + StationId + "&Condition=" + _condition + "");
            }
            else
            {
                ASPxButton btn = sender as ASPxButton;
                ...
                var HisId = gridCondition.GetRowValues(index, "ItemId");
                //Page.ClientScript.RegisterStartupScript(this.GetType(), "OpenWindow",
                //      "window.open('../Production/ProductionOffline.aspx?Type=" + 0 + "&Hist=" + HisId + "&Stat=" + StationId + "','_newtab');",
                //      true);
                Response.Redirect("../Production/ProductionOffline.aspx?Type=" + 0 + "&Hist=" + HisId + "&Stat=" + StationId + "&Condition=" + _condition + "");
            }
        }
