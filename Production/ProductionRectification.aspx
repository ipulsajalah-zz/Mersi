<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="ProductionRectification.aspx.cs" Inherits="DotMercy.custom.Production.ProductionRectification" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
                            ...
                            <div>
                                ...
                                <%--<div style="display:inline-block; padding:5px">
                                    <dx:ASPxButton ID="btnMoveRecti" runat="server" AutoPostBack="false" Width="180px" Height="40px"
                                        Text="Send to Rectification" Font-Bold="true" Font-Size="13px" OnClick="btnMoveRecti_Click">
                                    </dx:ASPxButton>
                                </div>--%>
                                <div style="display: inline-block; padding: 5px">
                                    <dx:ASPxButton ID="btnMoveOffline" runat="server" AutoPostBack="false" Width="180px" Height="40px"
                                        Text="Send To End of Line" Font-Bold="true" Font-Size="13px">
                                        <ClientSideEvents Click="function(s, e) { ShowLoginWindow('EndOfLine'); }" />
                                    </dx:ASPxButton>
                                </div>
                                <%--<div style="display:inline-block; padding:5px">
                ...
                <ContentCollection>
                    <dx:ContentControl runat="server">
                        <dx:ASPxGridView ID="cpPerStationGrid" ClientInstanceName="cpPerStationGrid" runat="server" KeyFieldName="Id"
                            AutoGenerateColumns="False" SettingsBehavior-AllowSort="false" Width="100%" DataSourceID="GetAllCP">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="HasDeviation" VisibleIndex="26">
                                </dx:GridViewDataTextColumn>
                            </Columns>
    ...
    <dx:ASPxPopupControl ID="EndOfLine" runat="server" CloseAction="CloseButton" CloseOnEscape="true" Modal="True"
        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ClientInstanceName="EndOfLine"
        HeaderText="AuthKey" AllowDragging="True" PopupAnimationType="None" EnableViewState="False">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <div class="pcmButton">
                                            <span>&nbsp</span>
                                            <dx:ASPxButton ID="btOK" runat="server" Text="OK" Width="70px" AutoPostBack="False" OnClick="BtnEndOffLine_Click">
                                            </dx:ASPxButton>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="pcmButton">
                                            ...
                                            <dx:ASPxButton ID="btCancel" runat="server" Text="Cancel" Width="50px" AutoPostBack="False">
                                                <ClientSideEvents Click="function(s, e) { EndOfLine.Hide(); }" />
                                            </dx:ASPxButton>
    ...
    <dx:ASPxPopupControl ID="PopUpEndOffLine" runat="server" ShowCloseButton="false" CloseOnEscape="false" CloseAction="None"
        ...
        HeaderText="Select Target Station" AllowDragging="True" Modal="True" PopupAnimationType="Fade" EnableViewState="false" OnWindowCallback="pcInteruptFault_WindowCallback">
        <ContentCollection>
            <dx:PopupControlContentControl runat="server">
                <div style="display: inline-flex;">
                    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server">
                        <Items>
                            <dx:LayoutItem Caption="Station In End Of Line">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                    ...
                    <dx:ASPxButton ID="SubmitButton" runat="server" AutoPostBack="false"
                        Text="Send To End Line" Font-Bold="true" OnClick="btnMoveOffline_Click" Style="margin: auto 0;">
                    </dx:ASPxButton>
                </div>
    ...
    <asp:SqlDataSource ID="DataCmbEndOfflIne" runat="server"
        ConnectionString="<%$ ConnectionStrings:AppDb %>"
        SelectCommand="select a.*,b.AssemblySectionName from stations a inner join AssemblySection b on a.AssemblySectionId = b.Id where b.AssemblySectionName = 'End of Line' or b.AssemblySectionName='Finish Line'"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="GetAllCP" runat="server"
        ConnectionString="<%$ ConnectionStrings:AppDb %>"
    ...
    <asp:SqlDataSource ID="sdsCgis" runat="server"
       ...
       SELECT cpp.Id, cpp.ProcessNo, cpp.ProcessName, cpp.Rf, cpp.CgisNo, cpp.PartNumber, cpp.PartDescription
		FROM ControlPlanProcesses cpp
	    WHERE cpp.ControlPlanId = (
		    SELECT cp.Id FROM ControlPlans cp join ( 
			    SELECT TOP 1 vod.PackingMonth, vod.ModelId, vod.VariantId FROM VehicleOrderDetails vod
