<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="VehicleDeliveryOrder_RECEIVED.aspx.cs" Inherits="DotMercy.custom.VehicleDeliveryOrder_RECEIVED" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <span style="font-size: 18px; float: left; font-weight: bolder; padding-bottom: 15px;">Vehicle Delivery Order Received</span>
    ...
    <dx:ASPxGridView ID="grid" runat="server" ClientInstanceName="grid" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnInit="grid_Init" OnCustomCallback="grid_CustomCallback" OnCustomButtonCallback="grid_CustomButtonCallback" OnHtmlRowPrepared="grid_HtmlRowPrepared" OnHtmlDataCellPrepared="grid_HtmlDataCellPrepared" >
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="ProdOutDate" VisibleIndex="6" Width="70" CellStyle-Wrap="True" CellStyle-HorizontalAlign="Center" PropertiesTextEdit-DisplayFormatString="dd/MM/yyyy">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="OrderNo" VisibleIndex="7">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="BuyOutDate" Caption="Buy Off Date" VisibleIndex="8" CellStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" PropertiesTextEdit-DisplayFormatString="dd/MM/yyyy - HH:mm:ss ">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="BPK" Caption="Confirm BPK" VisibleIndex="9" Width="90" HeaderStyle-HorizontalAlign="Center">
                ...
                <DataItemTemplate>
                    <dx:ASPxButton ID="btnBPK" Visible="false" runat="server" CommandArgument='<%# Eval("Id") %>' RenderMode="Link" Text="Confirm" OnClick="btnBPK_OnClick">
                        <Image Height="12px" Url="~/Content/Images/glyphicons-145-folder-open.png" Width="16px">
                        </Image>
                    </dx:ASPxButton>
                    <dx:ASPxLabel ID="lblBPK" Visible="false" runat="server" CommandArgument='<%# Eval("Id") %>' RenderMode="Link" Text="Confirm">
                    </dx:ASPxLabel>
                </DataItemTemplate>
