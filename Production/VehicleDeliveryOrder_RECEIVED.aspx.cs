...
{
    public partial class VehicleDeliveryOrder_RECEIVED : Ebiz.Scaffolding.WebForm.UI.CustomPage
    {
        ...
        protected void btnRCV_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (i != 0 || i != null)
                {
                    ...
                    SqlDataSource1.UpdateCommand = "UPDATE VPCStorage SET ReceivedByMarketingBy ='" + user + "' WHERE Id =" + i;
