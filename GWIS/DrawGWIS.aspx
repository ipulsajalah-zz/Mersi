<%@ Page Language="C#" AutoEventWireup="true" UnobtrusiveValidationMode="None" CodeBehind="DrawGWIS.aspx.cs" Inherits="Ebiz.WebForm.custom.GWIS.DrawGWIS" %>
...
<meta http-equiv="Expires" content="0" />
    ...
    <link rel="Stylesheet" type="text/css" href="/Content/css/cmptheme.css" />
...
<%--    <script type="text/javascript" src="../Scripts/jquery-1.7.1.js"></script>    
    ...
    <link rel="stylesheet" type="text/css" href="/Content/jquery-ui/jquery-ui.min.css" />
...
<body>
            ...
            <div id="dialog" style="display: none; padding-left: 5px; padding-top: 0;">
                ...
                <table class="tableinput" id="input_table" style="margin-top: 0; padding-top: 0; padding-bottom: 0;">
                    ...
                    <tr>
                        ...
                        <td class="ttl"><asp:Button ID="Button_Save" runat="server" Text="Draw" style="display: none;" CssClass="inputan button" ValidationGroup="drawGroup" OnClick="Button_Save_Click"/></td>
                    </tr>
                    </tbody> <a href="DrawGWIS.aspx">DrawGWIS.aspx</a>
                </table>
            </div> 
        </td>
    ...
    <ItemTemplate>
                <tr class="rowhighlight normal" bgcolor="<%# (Container.ItemIndex % 2 == 0 ? "" : "#f2f2f2") %>">
                    ...
                    <td>
                        <asp:Button ID="Button_Delete_Data" runat="server" CssClass="inputan button" Text="Delete" CommandArgument='<%# string.Format("{0},{1}", Eval("id"), Eval("edit_date")) %>' CommandName="delete" OnClick="Button_Delete_Data_Click" OnClientClick="return confirm('Are you sure you want to delete this data ?');" /><br />
                    </td>
                </tr>
    </ItemTemplate>
    <FooterTemplate>
        ...
        <td style="vertical-align: top;">
            <table class="tableinput" id="edit_table" style="display: none; width: auto;">
                ...
                <tr>
                    ...
                    <asp:Button ID="Button_Edit" runat="server" Text="Edit" CssClass="inputan button" OnClick="Button_Edit_Click" /></td>
                    <td class="ttl"><br />
