<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.master" AutoEventWireup="true" CodeBehind="STAViewSingle.aspx.cs" Inherits="Ebiz.WebForm.custom.STA.STAViewSingle" %>
...
<asp:Content ID="content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="sdsUsers1" runat="server"
        ConnectionString="<%$ ConnectionStrings:AppDb %>"
        SelectCommand="SELECT uo.UserId, uo.FullName FROM vUserOrganizations uo
        where (uo.OrganizationId = @organizationId or u.UserId = @userId) ORDER BY FullName">
        <SelectParameters>
            <asp:Parameter Name="organizationId" />
    ...
    <asp:SqlDataSource ID="sdsUsers2" runat="server"
        ConnectionString="<%$ ConnectionStrings:AppDb %>"
        SelectCommand="SELECT uo.UserId, uo.FullName FROM vUserOrganizations uo
        where (uo.OrganizationId = @organizationId or u.UserId = @userId) ORDER BY FullName">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="sdsUsers3" runat="server"
        ConnectionString="<%$ ConnectionStrings:AppDb %>"
        SelectCommand="SELECT uo.UserId, uo.FullName FROM vUserOrganizations uo
        where (uo.OrganizationId = @organizationId or u.UserId = @userId) ORDER BY FullName">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="sdsUsers4" runat="server"
        ConnectionString="<%$ ConnectionStrings:AppDb %>"
        SelectCommand="SELECT uo.UserId, uo.FullName FROM vUserOrganizations uo
        where (uo.OrganizationId = @organizationId or u.UserId = @userId) ORDER BY FullName">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="sdsUsers5" runat="server"
        ConnectionString="<%$ ConnectionStrings:AppDb %>"
        SelectCommand="SELECT uo.UserId, uo.FullName FROM vUserOrganizations uo
        where (uo.OrganizationId = @organizationId or u.UserId = @userId) ORDER BY FullName">
        <SelectParameters>
