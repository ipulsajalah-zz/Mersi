<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="ProductionSequence.aspx.cs" Inherits="Ebiz.WebForm.custom.PPC.ProductionSequence" %>
...
<asp:Content ID="content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2 class="grid-header">Production Sequence</h2>
...
<%--        <div style="text-align: left; font-weight: bolder">--%>
            <dx:ASPxButton runat="server" ID="btnUpload" ClientInstanceName="btnUpload" Text="Upload Sequence" AutoPostBack="false">
